...
public class BlackBoxCodegenTestGenerated extends AbstractBlackBoxCodegenTest {
    ...
    public static class PrimitiveTypes extends AbstractBlackBoxCodegenTest {
        ...
        @TestMetadata("kt16726.kt")
        public void testKt16726() throws Exception {
            String fileName = KotlinTestUtils.navigationMetadata("compiler/testData/codegen/box/primitiveTypes/kt16726.kt");
            doTest(fileName);
        }
